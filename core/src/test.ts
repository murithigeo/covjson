...
const referencing: CoverageJSON.ReferenceSystemConnection[] = [
	{
		coordinates: ['x', 'y'],
		system: {
			type: 'GeographicCRS',
...
const verticalProfileCoverage: CoverageJSON.Coverage = {
	...
	domain: {
		...
		axes: {
			...
			z: {
				values: [
					5.4562, 8.9282, 14.8802, 20.832, 26.7836, 32.735, 38.6863, 44.6374, 50.5883, 56.5391,
					62.4897, 68.4401, 74.3903, 80.3404, 86.2902, 92.24, 98.1895, 104.1389, 110.0881, 116.0371,
					121.9859
				]
			},
	...
	ranges: {
		PSAL: {
			...
			axisNames: ['z'],
			values: [
				43.9599, 43.9599, 43.964, 43.964, 43.9679, 43.9879, 44.004, 44.012, 44.012, 44.0159, 44.032,
				44.032, 44.048, 44.0559, 44.0559, 44.0579, 44.068, 44.074, 44.0779, 44.088, 44.094
			]
		},
		POTM: {
			type: 'NdArray',
			...
			axisNames: ['z'],
			values: [
				23.8, 23.7, 23.5, 23.4, 23.2, 22.4, 21.8, 21.7, 21.5, 21.3, 21.0, 20.6, 20.1, 19.7, 19.4,
				19.1, 18.9, 18.8, 18.7, 18.6, 18.5
			]
		}
	}
};
...
const continousDataParameter: CoverageJSON.Parameter = {
	type: 'Parameter',
	description: {
...
const categoricalDataParameter: CoverageJSON.Parameter = {
	type: 'Parameter',
	description: {
...
const vectorQuantityParameterGroup: CoverageJSON.ParameterGroup = {
	type: 'ParameterGroup',
	observedProperty: {
		label: {
			en: 'Wind velocity'
...
const uncertaintyParameterGroup: CoverageJSON.ParameterGroup = {
	type: 'ParameterGroup',
	label: {
...
// SST mean parameter
const sstMeanParameter: CoverageJSON.Parameter = {
	type: 'Parameter',
	observedProperty: {
		label: {
...
const geographicCRS: CoverageJSON.SpatialReferenceSystem = {
	id: 'http://www.opengis.net/def/crs/EPSG/0/4979',
	type: 'GeographicCRS'
};

// Projected CRS
const projectedCRS: CoverageJSON.SpatialReferenceSystem = {
	id: 'http://www.opengis.net/def/crs/EPSG/0/32737',
	type: 'ProjectedCRS'
};

// Vertical CRS
const verticalCRS: CoverageJSON.SpatialReferenceSystem = {
	type: 'VerticalCRS',
	id: 'http://www.opengis.net/def/crs/EPSG/0/5703'
};

const temporalCRS: CoverageJSON.TemporalReferenceSystem = {
	type: 'TemporalRS',
	calendar: 'Gregorian'
};

// Geographic Identifier Reference System
const geographicIdentifierReferenceSystem: CoverageJSON.IdentifierBasedReferenceSystem = {
	type: 'IdentifierRS',
...
// Grid domain
const gridDomain: CoverageJSON.Grid = {
	type: 'Domain',
	domainType: 'Grid',
	axes: {
		x: { values: [1, 2, 3] },
...
// Point domain
const pointDomain: CoverageJSON.PointSeries = {
	type: 'Domain',
...
// Trajectory domain
const trajectoryDomain: CoverageJSON.Trajectory = {
	type: 'Domain',
...
// NdArray
const ndArray: CoverageJSON.NdArray = {
	type: 'NdArray',
	dataType: 'float',
	shape: [4, 2],
	axisNames: ['y', 'x'],
...
// Tiled NdArray
const tiledNdArray: CoverageJSON.TiledNdArray = {
	type: 'TiledNdArray',
	dataType: 'integer',
	axisNames: ['t', 'y', 'x'],
	shape: [2, 5, 10],
...
const tilesetA: CoverageJSON.NdArray = {
	type: 'NdArray',
	dataType: 'integer',
	axisNames: ['t', 'y', 'x'],
	shape: [2, 5, 10],
...
// MultiPointSeries
const multiPointSeriesDomain: CoverageJSON.MultiPointSeries = {
	type: 'Domain',
...
const multiPointSeriesWithoutZ: CoverageJSON.MultiPointSeries = {
	type: 'Domain',
	domainType: 'MultiPointSeries',
	axes: {
		t: { values: ['2008-01-01T04:00:00Z', '2008-01-01T05:00:00Z'] },
...
const polygonDomain: CoverageJSON.Polygon = {
	type: 'Domain',
	domainType: 'Polygon',
	axes: {
		composite: {
...
const sectionDomain: CoverageJSON.Section = {
	type: 'Domain',
	domainType: 'Section',
	axes: {
		z: { values: [10, 20, 30] },
...
const multipointDomain: CoverageJSON.MultiPoint = {
	type: 'Domain',
...
const multiPointDomainWithoutTandZ: CoverageJSON.MultiPoint = {
	type: 'Domain',
	domainType: 'MultiPoint',
	axes: {
		composite: {
...
const multipolygonDomain: CoverageJSON.MultiPolygon = {
	type: 'Domain',
...
const multipolygonseriesDomain: CoverageJSON.MultiPolygonSeries = {
	type: 'Domain',
...
const coverageWithRemoteDomainRange: CoverageJSON.Coverage = {
	type: 'Coverage',
...
const gridDomainWithRegularElevation: CoverageJSON.CoverageJSON = {
	type: 'Domain',
	domainType: 'Grid',
	axes: {
		x: { values: [10, 20] },
...
const sectionWithRegularElevation: CoverageJSON.Domain = {
	type: 'Domain',
	domainType: 'Section',
	axes: {
		composite: {
...
const verticalprofilewithRegularElevation: CoverageJSON.Domain = {
	type: 'Domain',
	domainType: 'VerticalProfile',
	axes: {
...
const GenericCoverage: CoverageJSON.Coverage = {
	type: 'Coverage',
	domain: 'https://covjson.org/playground/coverages/grid-domain.covjson',
	ranges: {}
};

const paramGroup: CoverageJSON.ParameterGroup = {
	type: 'ParameterGroup',
	label: {
		en: 'Wind'
	},
...
const pointCollection: CoverageJSON.CoverageCollection<CoverageJSON.PointSeries> = {
	type: 'CoverageCollection',
	domainType: 'PointSeries',
	coverages: [
		{
...
const remotePointCollection: CoverageJSON.CoverageCollection = {
	type: 'CoverageCollection',
	domainType: 'Point',
	coverages: [
		{
			type: 'Coverage',
			domainType: 'PointSeries',
			domain: 'https://covjson.org/playground/coverages/point-domain.covjson',
			ranges: {}
		}
	]
};
