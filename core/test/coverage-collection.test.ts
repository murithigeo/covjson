...
describe('Data Retrieval', async () => {
  ...
  it('Returns undefined for non-existent ranges', async () => {
    await expect(v1.getData([0, 0], ['POTM', 'qc', 'RANDOHM'])).resolves.toEqual([
